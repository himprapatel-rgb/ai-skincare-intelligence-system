...
- Historical implementation status docs
- Old sprint planning documents that are no longer active

## Naming Convention
- `Sprint-N-Feature-COMPLETE-YYYYMMDD.md` (e.g., Sprint-1-Core-MVP-COMPLETE-20251220.md)
- `Sprint-N-Phase-M-Summary-YYYYMMDD.md`
- `Sprint-N-Retrospective-YYYYMMDD.md`
